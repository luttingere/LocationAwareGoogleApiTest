package demo.reaxium.com.androidlocationtester.util;
...
public class MarkerAnimation {
    ...
    public static void animateMarkerToGB(final Marker marker, final LatLng finalPosition, final LatLngInterpolator latLngInterpolator, float duration) {
